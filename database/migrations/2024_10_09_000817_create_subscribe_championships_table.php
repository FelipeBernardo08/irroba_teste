...
class CreateSubscribeChampionshipsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('subscribe_championships', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('subscribe_championships');
    }
}
